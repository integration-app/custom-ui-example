...
const INTEGRATION_KEY = "pipedrive"
const DATASOURCE_KEY = "contacts"
const FIELD_MAPPING_KEY = "contacts-mapping"
        ...
        <>
            {
                integration ? (
                    <>
                        ...
                        {collection && (<FieldMapping fieldMappingKey={FIELD_MAPPING_KEY} integrationKey={INTEGRATION_KEY}></FieldMapping>)}
